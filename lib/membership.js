// ════════════════════════════════════════════════════════
//  HITTRACK — Membership Library  (mobile copy)
//
//  Ported VERBATIM from the web app (hittrack-web/src/lib/membership.js).
//  Keep these two files identical so web + mobile derive the same state.
//
