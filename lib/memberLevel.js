// ════════════════════════════════════════════════════════════════
//  CANONICAL MEMBER LEVEL — single source of truth (shared with web).
//  Ported verbatim from hittrack-web/src/lib/memberLevel.js so web and
//  mobile resolve a member's division identically.
//
